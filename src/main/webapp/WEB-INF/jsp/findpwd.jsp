...
<title>비밀번호찾기</title>
	<STYLE TYPE="text/css">
		...
		div#box1 {width: 750px; height: 300px; background-color: #ffffff; border: 5px solid black; position: relative; left: 530px; top: 20px}
		...
		button#button1 {width: 200px; height: 100px; background-color: black; color: white; position: relative; left: 800px; top: 200px}
		-->
	</STYLE>
